                  ...
                  setState(() {
                    if (currentIndex < questions.length - 1) {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DASSResult(scores: scores),
                        ),
                      );
                    }
                  });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('DASS Test', style: TextStyle(color: Colors.black)),
      ),
      body: SingleChildScrollView(
        child: _buildQuestionCard(currentIndex),
      ),
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            ...
            child: Text(currentIndex < questions.length - 1 ? 'Continue' : 'Finish'),
          ),
        ],
      ),
    );
